...
#define OLED_CMD_DISPLAY_NO_SCROLL 0x2E

// Addressing Command Table (pg.30)
#define OLED_CMD_SET_MEMORY_ADDR_MODE \
  0x20  // follow with 0x00 = HORZ mode = Behave like a KS108 graphic LCD
...
#define OLED_CMD_SET_SEGMENT_REMAP      0xA1 //mirrir
//#define OLED_CMD_SET_SEGMENT_REMAP 0xA0 // no mirror
#define OLED_CMD_SET_MUX_RATIO 0xA8      // follow with 0x3F = 64 MUX
#define OLED_CMD_SET_COM_SCAN_MODE 0xC8  // no flip
//#define OLED_CMD_SET_COM_SCAN_MODE      0xC0    // flip
