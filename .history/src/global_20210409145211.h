...
#define ANL2adr 0x28  // Analog input P2
#define ANL3adr 0x30  // Analog input P3
#define ANL4adr 0x01  // Analog input P4
#define ANL5adr 0x02  // Analog input P5
#define ANL6adr 0x06  // Analog input P6
#define ANL7adr 0x0   // Analog input P7
#define ANL8adr 0x0   // Analog input P8
#define FANadr 0x08   // Analog Fan
#define TEMPadr 0x00  // Analog Fan
#define RHadr 0x18    // Analog Fan
