      ...
      case modeFanAuxBoxRetro:
        ...
        if (ch != 0xFF) {
          ...
          if (ch == '2') {
            ...
            ESP_LOGI(TAG, "T1   %d Raw", ANL2adr);
            ESP_LOGI(TAG, "T2   %d Raw" ,ANL3adr);
            ESP_LOGI(TAG, "T3   %d Raw",ANL4adr);
            ESP_LOGI(TAG, "T1   %03.02fC ", new_ntc_sample(ANL2adr));
            ESP_LOGI(TAG, "T2   %03.02fC ", new_ntc_sample(ANL3adr));
            ESP_LOGI(TAG, "T3   %03.02fC ", new_ntc_sample(ANL4adr));
          }
