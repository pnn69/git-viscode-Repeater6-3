      ...
      case modeFanAuxBoxRetro:
        ...
        if (ch != 0xFF) {
          ...
          if (ch == '2') {
            ...
            ESP_LOGI(TAG, "T1   %d Raw",4095-ADC[1]);
            ESP_LOGI(TAG, "T2   %d Raw",4095-ADC[2]);
            ESP_LOGI(TAG, "T3   %d Raw",4095-ADC[3]);
            ESP_LOGI(TAG, "T1   %03.02fC ", new_ntc_sample5v(4095-ADC[1]));
            ESP_LOGI(TAG, "T2   %03.02fC ", new_ntc_sample5v(4095-ADC[2]));
            ESP_LOGI(TAG, "T3   %03.02fC ", new_ntc_sample5v(4095-ADC[3]));
          }
